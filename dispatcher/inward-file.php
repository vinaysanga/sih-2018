  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    border-width: 2px;">
        <div class="text-center">
            ...
            </div><div class="col-md-6">    <button id="take_snapshots" class="btn btn-success btn-sm" type="submit">Capture QR Code</button></div>
            <hr><br>
        </div>
    </div><br><br>
        <div class="col-md-4"></div>    
        <div id="decodeQR" class="col-md-5" style="background-color: white; padding: 20px; box-shadow: 10px 10px 5px #888;display: none">
            <div class="panel panel-heading">
                <h1>Decode QR codes</h1>
            </div>
            <hr>
            <form action="decode.php" method="post" enctype="multipart/form-data">
                <input type="file" name="qrimage" accept="image/*" id="qrimage" class=""><br>
                <button type="submit" class="btn btn-md btn-block btn-primary" value="Decode the Code">Decode</button>
            </form>
