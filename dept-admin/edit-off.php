            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 well">
                    <div class="panel panel-blue">
                        <h3 class="text-center">Edit Officer</h3>
                    </div> 
                    <?php
                    ...
                    ?>
                    <form method="post" action="save-officer.php">
                        ...
                        <div class="form-group">
                            <button type="submit" class="form-control btn btn-success" name="submit" id="submit">Save Officer</button>
                        </div>
                    </form>
                    <?php
                          }
