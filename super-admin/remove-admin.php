            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 well">
                    <div class="panel panel-blue">
                        <h3 class="text-center">Delete Departmental Admin</h3>
                    </div>                     
                    <?php
                    ...
                    ?>
                    <form method="post" action="remove-dept-admin.php">
                        ...
                        <div class="form-group">
                            <button type="submit" class="form-control btn btn-success" name="ssubmit" id="ssubmit">Delete Admin</button>
                        </div>
                    </form>
                    <?php
                        }
