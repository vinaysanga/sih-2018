    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Departmental Admin</li>
                </ol>
            </div><!--/.row-->
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Departmental Admin</h1>
                </div>
                                ...
                                <tbody>
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td><a href="edit_admin.php?id=<?php echo $row['id_admin'];?>">Edit</a>&nbsp;|&nbsp;<a href="remove-admin.php?id=<?php echo $row['id_admin'];?>">Remove</a></td>
                                    </tr>  
                                 <?php
                                    }
                                  }
